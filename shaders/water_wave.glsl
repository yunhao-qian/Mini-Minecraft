...
const float WaterWaveAmplitudes[WaterWaveCount]
    = float[](0.03213, 0.05055, 0.04116, 0.04500, 0.05786, 0.06787);
...
const float WaterWaveExponents[WaterWaveCount] = float[](1.0, 3.0, 2.0, 4.0, 1.5, 2.5);
