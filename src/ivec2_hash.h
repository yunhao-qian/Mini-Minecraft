#ifndef MINI_MINECRAFT_IVEC2_HASH_H
#define MINI_MINECRAFT_IVEC2_HASH_H
...
inline std::size_t IVec2Hash::operator()(const glm::ivec2 v) const
{
...
#endif // MINI_MINECRAFT_IVEC2_HASH_H
